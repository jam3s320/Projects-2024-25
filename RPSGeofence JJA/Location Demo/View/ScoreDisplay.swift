...
//        let myNewDate = myDateFormatter.string(from: dateAtEnd)
//
...
//    var body: some View {
//        
//        let scores: String = data.items.reduce("") { (result, item) in
//            return result + item.summary + "(" + item.status + ")" + "    ***    "
//        }//        let text = data.items.first?.summary
//
//        Color.white
